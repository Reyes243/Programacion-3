...
public class Ventana3 {
	...
	private JTextField txtJoseReyes;
	private JTextField txtHinojosa;
	...
	private void initialize() {
		...
		txtJoseReyes = new JTextField();
		txtJoseReyes.setText("Jose Reyes");
		txtJoseReyes.setBorder(BorderFactory.createMatteBorder(10, 0, 10, 20, new Color(0, 255, 255) ));
		panel_7.add(txtJoseReyes);
		txtJoseReyes.setColumns(10);
		...
		txtHinojosa = new JTextField();
		txtHinojosa.setText("Hinojosa");
		txtHinojosa.setBorder(BorderFactory.createMatteBorder(10, 0, 10, 20, new Color(0, 255, 255) ));
		panel_7.add(txtHinojosa);
		txtHinojosa.setColumns(10);
		...
		txtTorres.setText("Torres");
		txtTorres.setBorder(BorderFactory.createMatteBorder(10, 0, 10, 20, new Color(0, 255, 255) ));
		panel_7.add(txtTorres);
		txtTorres.setColumns(10);
		...
		textField_3.setText("27/06/2003");
		...
		txtrDarkSoulsEs.setText("Dark Souls es una serie de juegos de rol de acción creada por Hidetaka Miyazaki de FromSoftware y publicada por Bandai Namco Entertainment.");
		...
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\PC WHITE WOLF\\Downloads\\nuevo.png"));
		...
		btnNewButton_1.setIcon(new ImageIcon("C:\\Users\\PC WHITE WOLF\\Downloads\\guardar.png"));
		...
		btnNewButton_2.setIcon(new ImageIcon("C:\\Users\\PC WHITE WOLF\\Downloads\\salir.png"));
