...
public class Evaluación_unidad_2 {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Factura en Java-Examen ");
		...
		txtJoseReyes.setBounds(394, 33, 160, 20);
		panel_2.add(txtJoseReyes);
		...
		JLabel lblNewLabel_10 = new JLabel("3/26/2025");
		...
		ImageIcon port =new ImageIcon("imagenes/lista.png");
		Image port1= port.getImage();
		Image port2=port1.getScaledInstance(18, 18,Image.SCALE_SMOOTH);
		lblNewLabel_11.setIcon(new ImageIcon(port2));
		
		JButton btnNewButton_2 = new JButton("Eliminar");
		btnNewButton_2.setBounds(438, 11, 116, 23);
		panel_4.add(btnNewButton_2);
		ImageIcon port3 =new ImageIcon("imagenes/eliminar.png");
		Image port4= port3.getImage();
		Image port5=port4.getScaledInstance(22, 22,Image.SCALE_SMOOTH);
		btnNewButton_2.setIcon(new ImageIcon(port5));
		
		JButton btnNewButton_3 = new JButton("Añadir");
		btnNewButton_3.setBounds(312, 11, 116, 23);
		panel_4.add(btnNewButton_3);
		ImageIcon port6 =new ImageIcon("imagenes/circulo.png");
		Image port7= port6.getImage();
		Image port8=port7.getScaledInstance(22, 22,Image.SCALE_SMOOTH);
		btnNewButton_3.setIcon(new ImageIcon(port8));
